# Emare Crypto — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/emarecripto
...
| 6 | `emarecripto_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `emarecripto Dervishi` bu projeden sorumlu
