...
```python
# Emare Crypto — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'emarecripto.view',      # Görüntüleme
    'emarecripto.create',    # Oluşturma
    'emarecripto.edit',      # Düzenleme
    'emarecripto.delete',    # Silme
    'emarecripto.manage',    # Tam yönetim
    # Admin
    'emarecripto.admin',     # Admin panele erişim
    'emarecripto.users',     # Kullanıcı yönetimi
    'emarecripto.settings',  # Ayar yönetimi
]
```
...
```python
# emarecripto/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'emarecripto.view', 'emarecripto.create',
        'emarecripto.edit', 'emarecripto.delete',
        'emarecripto.manage', 'emarecripto.users',
        'emarecripto.settings', 'emarecripto.admin',
    },
    'operator': {
        'emarecripto.view', 'emarecripto.create',
        'emarecripto.edit',
...
| Proje Admini | admin@emarecripto.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@emarecripto.emare.dev | super_admin | Machine-to-machine |
